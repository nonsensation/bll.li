    ...
    {#if game && visible}
        <div transition:fade class="timeline flex w-full flex-col gap-8 py-8">
            <div class="events mb-8 flex flex-col gap-8">
                <div
                    class="header sticky top-0 mb-4 grid grid-cols-3 border-b border-b-prim bg-sf py-4 *:flex *:flex-col *:place-content-center *:items-center"
                >
                    <div class="home">
                        <img
                ...
                {#each game.events as e, idx}
                    ...
                    {#if checkPeriod(e.period)}
                        ...
                        <h3 class="w-full py-8 font-normal text-txt2 md:text-center">{title}</h3>
                    {/if}

                    <div
                        class:even={idx % 2 === 0}
                        class="event border-l border-r border-transparent px-1 *:row-start-1 *:border-b-2 *:border-b-txt *:py-4 hover:border-prim"
                    >
