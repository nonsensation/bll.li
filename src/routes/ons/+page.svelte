...
<nav id="header" class="top-0 z-30 w-full py-1">
    <div class="container mx-auto mt-0 flex w-full flex-wrap items-center justify-between px-6 py-3">
        ...
        <div class="order-3 hidden w-full md:order-1 md:flex md:w-auto md:items-center" id="menu">
            <nav>
                <ul class="items-center justify-between pt-4 text-base text-gray-700 md:flex md:pt-0">
                    <li>
                        <a class="inline-block px-4 py-2 no-underline hover:text-black hover:underline" href="/"
                            >Herren</a
                        >
                    </li>
                    <li>
        ...
        <div class="order-1 md:order-2">
            <a
                class="flex items-center text-xl font-bold tracking-wide text-gray-800 no-underline hover:no-underline"
                href="/"
            >
                <svg
                    class="mr-2 fill-current text-gray-800"
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
...
<section
    class="bg-nordic-gray-light mx-auto flex w-full bg-cover bg-right pt-12 md:items-center md:pt-0"
    style="max-width:1600px; height: 32rem; background-image: url('https://www.kreisbote.de/assets/images/19/914/19914818-1287666944-20121118_vfl_kaufering_vs_black_lions_landsberg-saale_12-QA73.jpg');"
>
...
<section class="bg-gray-600 py-8">
    <div class="container grid grid-flow-col grid-cols-1 items-center justify-between px-2 py-3 md:grid-cols-3">
        <div class="w-full p-6 md:w-1/3">Regio</div>
        <div class="w-full p-6 md:w-1/3">Regio</div>
        <div class="w-full p-6 md:w-1/3">Regio</div>
    </div>
</section>
    ...
    <div class="container mx-auto flex flex-wrap items-center pb-12 pt-4">
        <nav id="store" class="top-0 z-30 w-full px-6 py-1">
            <div class="container mx-auto mt-0 flex w-full flex-wrap items-center justify-between px-2 py-3">
                <a
                    class="text-xl font-bold uppercase tracking-wide text-gray-800 no-underline hover:no-underline"
                    href="/"
                >
                    Spiele
                </a>
        ...
        <div class="flex w-full flex-col p-6 md:w-1/2 xl:w-1/3">
            <a href="/">
                <img
        ...
        <div class="flex w-full flex-col p-6 md:w-1/2 xl:w-1/3">
            <a href="/">
                <img
                    class="hover:grow hover:shadow-lg w-full object-cover"
...
<section class="bg-white py-8">
    <div class="container mx-auto px-6 py-8">
        <a
            class="mb-8 text-xl font-bold uppercase tracking-wide text-gray-800 no-underline hover:no-underline"
            href="/"
        >
            About
        </a>
        ...
        <p class="mb-8 mt-8">
            ...
            <br />
            <a class="text-gray-800 underline hover:text-gray-900" href="http://savoy.nordicmade.com/" target="_blank"
                >Savoy Theme</a
            >
            created by
            ...
            >
            and
            <a class="text-gray-800 underline hover:text-gray-900" href="https://www.metricdesign.no/" target="_blank"
                >https://www.metricdesign.no/</a
            >
        </p>

        <p class="mb-8">
            Lorem ipsum dolor sit amet, consectetur <a href="/">random link</a> adipiscing elit, sed do eiusmod tempor incididunt
            ut labore et dolore magna aliqua. Vel risus commodo viverra maecenas accumsan lacus vel facilisis volutpat. Vitae
            aliquet nec ullamcorper sit. Nullam eget felis eget nunc lobortis mattis aliquam. In est ante in nibh mauris.
            Egestas congue quisque egestas diam in. Facilisi nullam vehicula ipsum a arcu. Nec nam aliquam sem et tortor
            consequat. Eget mi proin sed libero enim sed faucibus turpis in. Hac habitasse platea dictumst quisque. In aliquam
            sem fringilla ut. Gravida rutrum quisque non tellus orci ac auctor augue mauris. Accumsan lacus vel facilisis
            volutpat est velit egestas dui id. At tempor commodo ullamcorper a. Volutpat commodo sed egestas egestas fringilla.
            Vitae congue eu consequat ac.
        </p>
    </div>
</section>

<footer class="container mx-auto border-t border-gray-400 bg-white py-8">
    <div class="container flex px-3 py-8">
        <div class="mx-auto flex w-full flex-wrap">
            ...
            <div class="mt-6 flex w-full md:mt-0 lg:w-1/2 lg:justify-end lg:text-right">
                <div class="px-3 md:px-0">
                    <h3 class="text-left font-bold text-gray-900">Social</h3>

                    <div class="mt-0 flex w-full items-center py-4">
                        <a href="/" class="mx-2">
