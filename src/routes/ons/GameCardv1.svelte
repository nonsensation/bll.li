...
<a href={urlMatchReport} target="_blank">
    <section class:isToday class="rainbow">
        <div class="inner">
            ...
            <main class="main">
                <div class="home">
                    <img class="logo" alt="Logo {home_team_name}" src={urlLogoHome} decoding="async" loading="lazy" />
                ...
                <div class="guest">
                    <img class="logo" alt="Logo {guest_team_name}" src={urlLogoGuest} decoding="async" loading="lazy" />
...
<script lang="ts">
    ...
    const { matchResult, league, isToday } = gameCard;
    const { game_day, time, date, guest_team_name, home_team_name, result } = matchResult;

    const urlMatchReport = SM.UrlBuilder.getMatchReportUrl(matchResult.game_id, SM.LeagueId_Regio, SM.Slug_Ost);
